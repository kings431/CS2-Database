...
const { steamBotManager } = require('./lib/steam-bots-single.js')

async function testSingleBot() {
  console.log('🧪 Testing Single Steam Bot System...\n')
  ...
  try {
    ...
    console.log(`🔗 Bot online: ${bot.isOnline}`)
